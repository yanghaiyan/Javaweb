...
public class AppContext {
    ...
    public User getUser() {
        return (User)values.get(AppConstants.APP_CONTEXT_USER);
    }

    public void setUser(User user) {
        values.put(AppConstants.APP_CONTEXT_USER, user);
    }

    public String getUserName() {
        User user = (User)values.get(AppConstants.APP_CONTEXT_USER);
        if (user != null) {
